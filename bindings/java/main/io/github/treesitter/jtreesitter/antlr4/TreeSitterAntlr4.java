package io.github.treesitter.jtreesitter.antlr4;

import java.lang.foreign.*;

public final class TreeSitterAntlr4 {
    ...
    private static final TreeSitterAntlr4 INSTANCE = new TreeSitterAntlr4();

    private final Arena arena = Arena.ofAuto();
    private volatile SymbolLookup lookup = null;

    private TreeSitterAntlr4() {}
    ...
    public static MemorySegment language(SymbolLookup lookup) {
        return call(lookup, "tree_sitter_antlr4");
    }

    private SymbolLookup findLibrary() {
        try {
            var library = System.mapLibraryName("tree-sitter-antlr4");
            return SymbolLookup.libraryLookup(library, arena);
        } catch (IllegalArgumentException ex1) {
            try {
                System.loadLibrary("tree-sitter-antlr4");
